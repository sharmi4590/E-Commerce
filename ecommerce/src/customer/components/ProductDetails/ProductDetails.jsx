  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grids-col-1 lg:grid-cols-2 gap-x-8 px-4 pt-10">
          {/* Image gallery */}
        ...
        {/* rating and reviews */}
        <section>
          <h1 className="fonr-semibold text-lg pb-4">Recent Review & Ratign</h1>
...
Product Ratings
      ...
      <div className="flex item-center space-x-3">
        ...
        <p className="opacity-60">5945 Ratings</p>
      </div>
<Box className="mt-5 space-y-3">
  
  <Grid container alignItems="center" gap={2}>
    <Grid item xs={2}>
      <p className="space-x-6">Excellent</p>
